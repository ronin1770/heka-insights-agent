...
PACKAGE_FILE="${PYINSTALLER_DIST_DIR}/${PACKAGE_NAME}_${VERSION}_${ARCHITECTURE}.deb"
...
mkdir -p "${BUILD_ROOT}" "${PYINSTALLER_DIST_DIR}" "${PACKAGE_ROOT}/DEBIAN" "${DOC_DIR}"
...
install -m 0644 "${REPO_ROOT}/docs/release-packaging.md" "${DOC_DIR}/release-packaging.md"
